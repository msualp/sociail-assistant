...
OUT_DIR = Path("prototype/v2/base")
...
def main() -> None:
    ...
    with open(OUT_DIR / "README.txt", "w", encoding="utf-8") as f:
        f.write(
            "Sociail Assistant v2.0 (W35) - GENERATED SECOND-PASS PRINT ASSETS\n"
            "Generated: 2026-03-04\n\n"
            "This folder contains parametric STL meshes generated from\n"
            "../docs/design-spec.md dimensions for Bambu Studio use.\n\n"
            "Implemented in this pass:\n"
            "- 1.0mm tongue-and-groove seam (0.1mm clearance target)\n"
            "- 4x snap tabs near end arcs (+/-30deg locations)\n\n"
            "Canonical parts:\n"
            "- shell-top.stl\n"
            "- shell-bottom.stl\n\n"
            "Negative cutouts:\n"
