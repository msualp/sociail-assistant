...
OUT_DIR = Path("prototype/v2/r2-tight")
...
def main() -> None:
    ...
    with open(OUT_DIR / "README.txt", "w", encoding="utf-8") as f:
        f.write(
            "Sociail Assistant v2.0 (W35) - GENERATED R2-TIGHT SNAP-TUNED PRINT ASSETS\n"
            ...
            "- 4x snap tabs near end arcs (+/-30deg locations), tuned for stronger retention (higher insertion force)\n\n"
            "Canonical parts:\n"
            "- shell-top.stl\n"
            "- shell-bottom.stl\n\n"
            "Negative cutouts:\n"
