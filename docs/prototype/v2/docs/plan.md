...
This document tracks both the v1.2 canonical enclosure workflow and the v2.0 redesign workflow for producing a real, physical, demo-ready prototype on the Bambu Lab P1S.
...
```
v1/zips/w55-v1.2-full-negative-cutouts.zip
```
...
**Source files**
- assistant-v2.f3d (Fusion 360)
- assistant-v2.step (Universal exchange)
...
See `design-spec.md` for complete specifications.
