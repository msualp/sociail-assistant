...
Outputs:
- prototype/v3/sheets-r3-2/r3-2-loose-pair-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-mid-pair-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-tight-pair-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-loose-pair-sheet-screws.stl
- prototype/v3/sheets-r3-2/r3-2-mid-pair-sheet-screws.stl
- prototype/v3/sheets-r3-2/r3-2-tight-pair-sheet-screws.stl
- prototype/v3/sheets-r3-2/r3-2-abc-6up-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-abc-6up-sheet-screws.stl
- prototype/v3/sheets-r3-2/r3-2-abc-buttons-6up-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-default-cases-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-default-buttons-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-case-a-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-case-b-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-case-c-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-button-a-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-button-b-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-button-c-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-abc-bottoms-3up-sheet.stl
- prototype/v3/sheets-r3-2/r3-2-abc-bottoms-3up-sheet-screws.stl
...
OUT = ROOT / "sheets-r3-2"
VARIANTS = ["r3-2-loose", "r3-2-mid", "r3-2-tight"]
VARIANT_LABELS = [("a", "r3-2-loose"), ("b", "r3-2-mid"), ("c", "r3-2-tight")]
...
def main() -> None:
    ...
    for label, variant in VARIANT_LABELS:
        name, dims = build_case_material_sheet(
            ...
            "shell-top-print.stl",
            "shell-bottom-print.stl",
            f"r3-2-case-{label}-sheet.stl",
            flip_top=flip_case_tops,
        )
        summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

        name, dims = build_button_material_sheet(
            f"r3-2-button-{label}-sheet.stl",
    ...
    name, dims = build_button_6up_sheet(
        "r3-2-abc-buttons-6up-sheet.stl",
        flip_buttons=flip_buttons,
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-2-abc-6up-sheet.stl", "r3-2-default-cases-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-2-abc-buttons-6up-sheet.stl", "r3-2-default-buttons-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print.stl",
        "r3-2-abc-bottoms-3up-sheet.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print-screws.stl",
        "r3-2-abc-bottoms-3up-sheet-screws.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
