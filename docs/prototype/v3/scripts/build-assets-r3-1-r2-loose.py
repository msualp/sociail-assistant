...
OUT_DIR = Path("prototype/v3/r3-1-r2-loose")
...
SNAP_ENGAGE = 0.62
SNAP_TAB_THICK = 1.30
SNAP_SLOT_DEPTH = 2.00
SNAP_NOTCH_EXTRA = 0.74
...
- Looser seam tuning for faster A/B iteration and easier repeated opening
- Lower insertion force with reduced snap engagement
