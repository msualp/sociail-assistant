...
OUT_DIR = Path("prototype/v3/r3-1-r3")
...
SIDE_SCALLOP_DEPTH = 2.95
SIDE_SCALLOP_RADIUS = 48.0
SHOULDER_SCALLOP_DEPTH = 2.05
SHOULDER_SCALLOP_RADIUS = 52.0
CORNER_BLEND_DEPTH = 2.45
CORNER_BLEND_RADIUS = 40.0
...
GLOBAL_DRAFT_BOTTOM_SCALE = 1.14
GLOBAL_DRAFT_TOP_SCALE = 0.76
GLOBAL_DRAFT_BANDS = 56
GLOBAL_DRAFT_EXP = 0.58
...
def main() -> None:
    ...
    (OUT_DIR / "README.md").write_text(
        """# v3 R3.1-r3 Smooth Holistic Redesign (MagSafe)

Generated print assets for the v3.1-r3 holistic redesign: smooth bottom-led taper, deeper edge recess, and stronger corner softness.
