...
OUT_DIR = Path("prototype/v3/r3-2")
...
def main() -> None:
    ...
    (OUT_DIR / "README.md").write_text(
        """# v3 R3.2 Deep Sculpt (MagSafe)

Generated print assets for the v3.2 holistic redesign: deeper perimeter recess, fuller corner softening, and stronger top-to-bottom sculpting.
