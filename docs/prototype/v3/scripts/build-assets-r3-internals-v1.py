...
OUT_DIR = Path("prototype/v3/r3-internals-v1")
...
def battery_tray() -> mr.Mesh:
    ...
    parts.append(box_mesh(BoxSpec(BATTERY_SLOT_X * 0.5, BATTERY_WALL_T, 1.4, BATTERY_CX, BATTERY_CY - y_off, FLOOR_Z + 0.7)))
