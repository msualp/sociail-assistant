#!/usr/bin/env python3
"""
Generate v3 r3.1 MagSafe form-factor printable STL assets.
...
OUT_DIR = Path("prototype/v3/r3-1")
...
SIDE_SCALLOP_DEPTH = 2.05
SIDE_SCALLOP_RADIUS = 58.0
SHOULDER_SCALLOP_DEPTH = 1.40
SHOULDER_SCALLOP_RADIUS = 64.0
CORNER_BLEND_DEPTH = 1.35
CORNER_BLEND_RADIUS = 56.0
DRAFT_SIDE_DEPTH = 1.30
DRAFT_SIDE_RADIUS = 44.0
DRAFT_SIDE_Z = -4.0
DRAFT_SHOULDER_DEPTH = 0.85
DRAFT_SHOULDER_RADIUS = 40.0
DRAFT_SHOULDER_Z = -3.0
...
def main() -> None:
    ...
    (OUT_DIR / "README.md").write_text(
        """# v3 R3.1 Exterior Polish (MagSafe)

Generated print assets for the v3.1 exterior pass with stronger corner rounding and trapezoidal hand-feel shaping.
