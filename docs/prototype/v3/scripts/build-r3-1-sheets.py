#!/usr/bin/env python3
"""Generate sheet-style combined STLs for v3 r3.1 variants.

Outputs:
- prototype/v3/sheets-r3-1/r3-1-loose-pair-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-mid-pair-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-tight-pair-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-loose-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1/r3-1-mid-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1/r3-1-tight-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1/r3-1-abc-6up-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-abc-6up-sheet-screws.stl
- prototype/v3/sheets-r3-1/r3-1-abc-buttons-6up-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-default-cases-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-default-buttons-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-case-a-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-case-b-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-case-c-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-button-a-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-button-b-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-button-c-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-abc-bottoms-3up-sheet.stl
- prototype/v3/sheets-r3-1/r3-1-abc-bottoms-3up-sheet-screws.stl
...
OUT = ROOT / "sheets-r3-1"
VARIANTS = ["r3-1-loose", "r3-1-mid", "r3-1-tight"]
VARIANT_LABELS = [("a", "r3-1-loose"), ("b", "r3-1-mid"), ("c", "r3-1-tight")]
...
def main() -> None:
    ...
    for label, variant in VARIANT_LABELS:
        name, dims = build_case_material_sheet(
            ...
            "shell-top-print.stl",
            "shell-bottom-print.stl",
            f"r3-1-case-{label}-sheet.stl",
            flip_top=flip_case_tops,
        )
        summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

        name, dims = build_button_material_sheet(
            f"r3-1-button-{label}-sheet.stl",
    ...
    name, dims = build_button_6up_sheet(
        "r3-1-abc-buttons-6up-sheet.stl",
        flip_buttons=flip_buttons,
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-1-abc-6up-sheet.stl", "r3-1-default-cases-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-1-abc-buttons-6up-sheet.stl", "r3-1-default-buttons-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print.stl",
        "r3-1-abc-bottoms-3up-sheet.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print-screws.stl",
        "r3-1-abc-bottoms-3up-sheet-screws.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
...
## Files
- `r3-1-loose-pair-sheet.stl`: top+bottom print shells for r3-1-loose
- `r3-1-mid-pair-sheet.stl`: top+bottom print shells for r3-1-mid
- `r3-1-tight-pair-sheet.stl`: top+bottom print shells for r3-1-tight
- `r3-1-loose-pair-sheet-screws.stl`: top+bottom screw-hole print shells for r3-1-loose
- `r3-1-mid-pair-sheet-screws.stl`: top+bottom screw-hole print shells for r3-1-mid
- `r3-1-tight-pair-sheet-screws.stl`: top+bottom screw-hole print shells for r3-1-tight
- `r3-1-abc-6up-sheet.stl`: loose/mid/tight top+bottom together (6 parts)
- `r3-1-abc-6up-kit-sheet.stl`: loose/mid/tight top+bottom + 24mm button plungers/bezel guards (12 parts)
- `r3-1-abc-buttons-6up-sheet.stl`: three 24mm plungers + three 24mm bezels only (6 parts)
- `r3-1-default-cases-sheet.stl`: default case plate for multi-material workflow (alias of `r3-1-abc-6up-sheet.stl`)
- `r3-1-default-buttons-sheet.stl`: default button plate for multi-material workflow (alias of `r3-1-abc-buttons-6up-sheet.stl`)
- `r3-1-case-a-sheet.stl`: case material-test pair A (maps to r3-1-loose)
- `r3-1-case-b-sheet.stl`: case material-test pair B (maps to r3-1-mid)
- `r3-1-case-c-sheet.stl`: case material-test pair C (maps to r3-1-tight)
- `r3-1-button-a-sheet.stl`: button material-test pair A (24mm plunger + bezel)
- `r3-1-button-b-sheet.stl`: button material-test pair B (24mm plunger + bezel)
- `r3-1-button-c-sheet.stl`: button material-test pair C (24mm plunger + bezel)
- `r3-1-abc-6up-sheet-screws.stl`: loose/mid/tight top+bottom screw-hole set (6 parts)
- `r3-1-abc-bottoms-3up-sheet.stl`: loose/mid/tight bottoms only (3 parts)
- `r3-1-abc-bottoms-3up-sheet-screws.stl`: loose/mid/tight bottoms only with screw holes (3 parts)
...
- `r3-1-abc-6up-kit-sheet.stl` adds three 24mm plungers and three 24mm bezels for one-cycle A/B/C print runs.
- Default material-first flow: import `r3-1-default-cases-sheet.stl` + `r3-1-default-buttons-sheet.stl` as separate plates, then assign different filaments.
- For AMS material trials with less purge, use `r3-1-abc-6up-sheet.stl` (cases) plus `r3-1-abc-buttons-6up-sheet.stl` (buttons) on separate plates.
- A/B/C mapping: `A=r3-1-loose`, `B=r3-1-mid`, `C=r3-1-tight`.
- Fast AMS workflow: import `r3-1-case-a/b/c-sheet.stl` and `r3-1-button-a/b/c-sheet.stl` together, then assign filament by object name.
