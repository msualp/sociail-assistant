#!/usr/bin/env python3
"""Generate sheet-style combined STLs for v3 r3.1-r3 variants.

Outputs:
- prototype/v3/sheets-r3-1-r3/r3-1-r3-loose-pair-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-mid-pair-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-tight-pair-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-loose-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-mid-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-tight-pair-sheet-screws.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-abc-6up-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-abc-6up-sheet-screws.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-abc-buttons-6up-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-default-cases-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-default-buttons-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-case-a-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-case-b-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-case-c-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-button-a-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-button-b-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-button-c-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-abc-bottoms-3up-sheet.stl
- prototype/v3/sheets-r3-1-r3/r3-1-r3-abc-bottoms-3up-sheet-screws.stl
...
OUT = ROOT / "sheets-r3-1-r3"
VARIANTS = ["r3-1-r3-loose", "r3-1-r3-mid", "r3-1-r3-tight"]
VARIANT_LABELS = [("a", "r3-1-r3-loose"), ("b", "r3-1-r3-mid"), ("c", "r3-1-r3-tight")]
...
def main() -> None:
    ...
    for label, variant in VARIANT_LABELS:
        name, dims = build_case_material_sheet(
            ...
            "shell-top-print.stl",
            "shell-bottom-print.stl",
            f"r3-1-r3-case-{label}-sheet.stl",
            flip_top=flip_case_tops,
        )
        summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

        name, dims = build_button_material_sheet(
            f"r3-1-r3-button-{label}-sheet.stl",
    ...
    name, dims = build_button_6up_sheet(
        "r3-1-r3-abc-buttons-6up-sheet.stl",
        flip_buttons=flip_buttons,
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-1-r3-abc-6up-sheet.stl", "r3-1-r3-default-cases-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")

    name, dims = alias_sheet("r3-1-r3-abc-buttons-6up-sheet.stl", "r3-1-r3-default-buttons-sheet.stl")
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_6up_sheet(
        ...
        "shell-top-print-screws.stl",
        "shell-bottom-print-screws.stl",
        "r3-1-r3-abc-6up-sheet-screws.stl",
        flip_tops=flip_case_tops,
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print.stl",
        "r3-1-r3-abc-bottoms-3up-sheet.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
    ...
    name, dims = build_3up_row_sheet(
        VARIANTS,
        "shell-bottom-print-screws.stl",
        "r3-1-r3-abc-bottoms-3up-sheet-screws.stl",
    )
    summary.append(f"{name}: {dims[0]:.1f} x {dims[1]:.1f} x {dims[2]:.1f} mm")
