...
OUT_DIR = Path("prototype/v3/r3-1-r2-tight")
...
- Tighter seam tuning for stronger retention under repeated handling
- Higher insertion force with increased snap engagement
